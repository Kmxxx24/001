                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-left">
                                    ...
                                    <!-- course tag line-->
                                    <div class="course-note"><i class="far fa-calendar-alt"></i>  <?=$result2['cs_screen'];?></div>
                                    <!-- <div class="course-note"><i class="fab fa-internet-explorer"></i> -</div> -->
                                    <div class="course-note"><i class="far fa-building"></i> </div>
                                    <!-- <div class="course-note"><i class="fas fa-graduation-cap"></i> - </div> -->
                                    <div class="course-note"><i class="fas fa-wallet"></i> <?=$result2['cs_camera'];?></div>
